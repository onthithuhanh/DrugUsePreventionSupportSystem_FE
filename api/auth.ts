...
export const authApi = {
  ...
  updateCourseCategory: async (
    id: number,
    data: { name: string; description: string; age: string }
  ) => {
  ...
  updateCourseOption: async (
    optionId: number,
    data: { optionText: string; optionValue: number; displayOrder: number }
  ) => {
    const response = await api.put(`/CourseOption/${optionId}`, data);
    return response.data;
  },
  createCourseOption: async (
    questionId: number,
    data: { optionText: string; optionValue: number; displayOrder: number }
  ) => {
  ...
  updateRiskLevel: async (
    id: number,
    data: { riskLevel1: string; riskDescription: string }
  ) => {
  ...
  updateAgeGroup: async (
    id: number,
    data: { name: string; description: string; minAge: number; maxAge: number }
  ) => {
  ...
  createAssessmentQuestion: async (data: {
    assessmentId: number;
    questionText: string;
    questionType: string;
  }) => {
  ...
  updateAssessmentQuestion: async (
    id: number,
    data: { assessmentId: number; questionText: string; questionType: string }
  ) => {
  ...
  createAssessmentOption: async (data: {
    questionId: number;
    optionText: string;
    optionValue: number;
  }) => {
  ...
  updateAssessmentOption: async (
    id: number,
    data: { questionId: number; optionText: string; optionValue: number }
  ) => {
  ...
  addAssessment: async (data: any) => {
    const response = await api.post(`/assessment/full`, data);
    return response.data;
  },

  // User Assessment APIs
  submitUserAssessment: async (data: {
    userId: number;
    assessmentId: number;
    selectedOptionIds: number[];
  }) => {
    const response = await api.post("/UserAssessment/submit", data);
    return response.data;
  },
};
